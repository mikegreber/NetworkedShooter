...
void FGameplayTagStackContainer::Initialize()
{
...
void FGameplayTagStackContainer::Initialize(const FGameplayTagStackContainer& Container)
{
	for (const FGameplayTagStack& Stack : Container.Stacks)
	{
		AddStack(Stack.Tag, Stack.StackCount);
	}
}

void FGameplayTagStackContainer::AddStack(const FGameplayTagStack& Stack)
{
	AddStack(Stack.Tag, Stack.StackCount);
}
